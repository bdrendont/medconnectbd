...
class ConfigDb {
    ...
    private $db_user = "root"; // Nombre del usuario para conectarnos a la base de datos 
     private $db_pass = ""; // Contraseña del Usuario de la Base de datos
    private $db_name = "proovinos"; // Nombre de la Base de Datos
